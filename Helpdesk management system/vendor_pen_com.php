		...
		echo $_SESSION['report_at_name'];	
	      ...
	      <center>
					...
					if ($result2->num_rows > 0) {
						...
						echo "<th> Job No </th> <th> Vendor Comment</th> <th> Approved Person</th> <th>Remark </th><th>Approved Date</th><th> </th>";
						...
						echo "<td>" . $row['job_no'] ." </td>
								...
								<td>". $row['vendor_action']. "</td>						   
								<td style='width: 20%;'>".   $row['title'] .". ".  $row['f_name'] ." ". $row['l_name'] ."</td>	
								<td>". $row['appoved_reject_remark']. "</td>	
								<td>". $row['approved_reject_date']."</td>";
					 ...
					 $app_date=$row['approved_reject_date'];
					 $app_rem=$row['appoved_reject_remark'];
					 $app_officer=$row['title'] .". ".  $row['f_name'] ." ". $row['l_name'];

				
					 ?>
					<form   enctype="multipart/form-data" action="vendor_com_job" method="post" >
					...
					<?php  	 echo "<input   class='form-control' name='app_date' value='" . $app_date . "' type='hidden'  >"; ?>
					<?php  	 echo "<input   class='form-control' name='app_rem' value='" . $app_rem . "' type='hidden'  >"; ?>
					<?php  	 echo "<input   class='form-control' name='app_officer' value='" . $app_officer . "' type='hidden'  >"; ?>
					<?php
