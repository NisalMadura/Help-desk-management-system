  ...
  <div class="content-wrapper">
   ...
   <div class="container-fluid">
	...
	<div id="mainPage">
	   ...
	   <center>
	            <input type="text" id="txtsearch" class="form-control" autocomplete="on" onfocus="this.value=''"  style="width:600px;" onkeyup="showData()" placeholder="Enter Job Reference No..." /> </center>
            <br />
