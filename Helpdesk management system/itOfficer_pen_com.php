  ...
  <div class="content-wrapper">
   ...
   <div class="container-fluid">
		...
		echo $_SESSION['report_at_name'];	
	      ...
	      <center>
					<?php
	//-------------------- job complete from itOfficer_com_job.php--------------------------- -->

					if (isset($_POST['submit6'])) {			
										
						$job_no= $_POST['job_no'];
						$action_taken = $_POST['dis1'];	
						$com_fin = $_POST['Finish_Date'];
						$job_status="8";
						$report_at_user=$_SESSION['report_at'] 	;
						
					$sql_update00="UPDATE tbl_jobs SET job_status='$job_status',end_datetime='$com_fin',complete_officer='$report_at_user',comp_comment='$action_taken' where job_no='$job_no'";	
...
// end job complete				
				  ...
				  $rep_id=$_SESSION['report_at'];
					...
					if ($result2->num_rows > 0) {
						...
						echo "<th> Job No </th> <th> Reported User</th> <th> It Officer Comment</th> <th>Vendor Comment</th> <th>Vendor Complete Date</th><th> </th>";
						...
						echo "	<td>" . $row['job_no'] ." </td>	
								...
								<td>". $row['it_comment']."</td>	
								<td>". $row['ven_comment']."</td>			
								<td>". $row['vendor_co_date']."</td>";
					 ...
					 $vendor_co_date=$row['vendor_co_date'];
					 // $it_officer_code=$row['it_officer_code'];
					 $ven_comment=$row['ven_comment'];
					 ...
					 ?>
					<form   enctype="multipart/form-data" action="itOfficer_com_job.php" method="post" >
					...
					<?php  	 echo "<input   class='form-control' name='vendor_co_date' value='" . $vendor_co_date . "' type='hidden'  >"; ?>
					<?php  	 echo "<input   class='form-control' name='ven_comment' value='" . $ven_comment . "' type='hidden'  >"; ?>

	
					
					 <?php
						echo "<td>". "<button id='prebutton' type='submit5'  class='btn-success'>view detail</button>"."</td>";
