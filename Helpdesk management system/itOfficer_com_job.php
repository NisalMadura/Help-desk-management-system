 ...
 <!-- ------------------------------------------------------------------------------------------------------- -->
  ...
  <!-- -----------------------itOfficer_pen_com.php info--------------------------------------- -->
			   ...
			   <?Php
				...
				$vendor_co_date=$_POST['vendor_co_date'];
				$ven_comment=$_POST['ven_comment'];
...
//// End the It_officer Name And Con_no
	...
	<form   enctype="multipart/form-data" id="insert_form" action="itOfficer_pen_com.php"   method="post"  >
    <div class="form">
      <div class="form-row">
		  <div class="col-5.5">
					<ol class="breadcrumb">
								 ...
								 <table    bgcolor="#AED6F1  "  width ='450px;'style=' border-collapse:separate;border-spacing:2 15px; font-size: 12px; border-radius: 20px; '>
										 ...
										 <tr>	<td><b>VENDOR COMMENT</b></td>	<td>:-</td>	<td><?Php echo  $ven_comment; ?></td>  </tr>
										 <tr>	<td><b>VENDOR COMPLETE DATE</b></td>	<td>:-</td>	<td><span id="assign"><?Php echo $vendor_co_date; ?></span></td>  </tr>
			...
			<center><B>ACTION</B> 	
							...
							<center>	
										<table    bgcolor="#AED6F1  "  style=' border-collapse:separate;border-spacing:10 15px; font-size: 14px; border-radius: 25px; '>
										 ...
										 <tr>	<td><b>Finish Date and time</b></td>	<td>:-</td>	<td><input name="Finish_Date" id="Finish_Date" type='datetime-local' onchange="return completed()">
	...
	<center> <button type="submit" name="submit6" class="btn btn-primary"onclick="return checkVali();"   >Confim </button> </center>
		...
		function checkVali()
			{
				...
				var com_fin =document.getElementById("Finish_Date").value ;
